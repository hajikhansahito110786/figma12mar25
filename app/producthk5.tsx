...
<div className="w-[200px] h-[150px]  flex justify-center items-center">
 ...
 < Image priority={true} src={wingchair} alt ='hero-image' width={100} height={100} className="w-[100px] h-[100px]" />
...
<div className="w-[200px] h-[150px]  flex justify-center items-center">
 ...
 < Image src={whitesofa} alt ='hero-image' width={100} height={100} className="w-[100px] h-[100px]" />
...
<div className="w-[200px] h-[150px]  flex justify-center items-center">
 ...
 < Image src={smallwhitechair} alt ='hero-image' width={100} height={100} className="w-[100px] h-[100px]" />
